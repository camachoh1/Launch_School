...
function longestSentence(longText) {
  ...
  let longestSentence = sentences.sort((a,b) => b.split(' ').length - a.split(' ').length)[0];

  console.log(`The longest sentences in the text is: ${longestSentence}\n\nThe longest sentence has ${longestSentence.split(' ').length} words.`);
}

// // counting words from the longest sentence
...
longestSentence('What\'s up, "Doc"? Hi there!'); 
